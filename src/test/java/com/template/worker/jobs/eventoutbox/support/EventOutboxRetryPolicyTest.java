...
class EventOutboxRetryPolicyTest {
    ...
    void nextRetryAt_appliesCappedExponentialBackoff() {
        ...
        EventOutboxRetryPolicy retryPolicy = new EventOutboxRetryPolicy(properties);
    ...
    void isRetryable_classifiesExceptions() {
        EventOutboxRetryPolicy retryPolicy =
                new EventOutboxRetryPolicy(new EventOutboxProperties());
