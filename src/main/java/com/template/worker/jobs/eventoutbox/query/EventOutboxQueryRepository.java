...
public class EventOutboxQueryRepository {
    ...
    private static final RowMapper<EventOutboxRow> ROW_MAPPER =
            (resultSet, rowNum) ->
                    new EventOutboxRow(
    ...
    public List<EventOutboxRow> pollPublishableRows(
        ...
        MapSqlParameterSource params =
                new MapSqlParameterSource()
                        ...
                        .addValue(PARAM_PUBLISH_PENDING, EventOutboxStatus.PUBLISH_PENDING.name());
    ...
    public void markSent(long id, LocalDateTime updatedAt) {
        MapSqlParameterSource params =
                new MapSqlParameterSource()
                        ...
                        .addValue(PARAM_SENT, EventOutboxStatus.SENT.name())
    ...
    public void markFailed(long id, int retryCount, String lastError, LocalDateTime updatedAt) {
        MapSqlParameterSource params =
                new MapSqlParameterSource()
                        .addValue(PARAM_ID, id)
                        .addValue(PARAM_FAILED, EventOutboxStatus.FAILED.name())
                        .addValue(PARAM_RETRY_COUNT, retryCount)
                        .addValue(PARAM_LAST_ERROR, truncate(lastError))
                        .addValue(PARAM_UPDATED_AT, Timestamp.valueOf(updatedAt));
    ...
    public int countByStatus(EventOutboxStatus status) {
        MapSqlParameterSource params =
